...
-- Apply with `psql -h localhost -U postgres -d <database> -f supabase/schema.sql`
...
-- ---------------------------------------------------------------------------
-- Toutiao articles ingested by the crawler
-- ---------------------------------------------------------------------------
...
create index if not exists toutiao_articles_fetched_at_idx
    on public.toutiao_articles (fetched_at desc);
...
drop trigger if exists toutiao_articles_set_updated_at on public.toutiao_articles;
create trigger toutiao_articles_set_updated_at
    before update on public.toutiao_articles
